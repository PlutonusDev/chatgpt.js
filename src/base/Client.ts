...
export default class ChatGPTClient {
    ...
    async call(prompt: String, conversation_id?: String,) {
        return new Promise(async (res, rej) => {
            ...
            }).catch(e => {rej(`SESSION REQUEST: ${e.code} - ${e.response.data.detail?.code || "Unknown OpenAI Error!"}`);/*console.log(e)*/});
            ...
            if(!sessionCookie) return rej("SESSION REQUEST: Session token wasn't returned!");
